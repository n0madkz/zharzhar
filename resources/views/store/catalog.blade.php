...
<span class="card-shade" aria-hidden="true"></span><span class="mini-kicker">{{ $template->event_type === 'qyz_uzatu' ? 'ҚЫЗ ҰЗАТУ' : ($template->event_type === 'anniversary' ? 'МЕРЕЙТОЙ' : 'БІЗ ҮЙЛЕНЕМІЗ') }}</span><span class="card-ring" aria-hidden="true"></span><strong>{{ $template->name }}</strong><span class="mini-date">12 / 09 / 2026</span>
