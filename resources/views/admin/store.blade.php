...
'format'=>['label'=>'Формат приглашения','config'=>'format','default'=>'web','options'=>['web'=>'Сайт-приглашение','video'=>'Видеоприглашение']],
'video_url'=>['label'=>'Ссылка или путь к видео','config'=>'video_url','wide'=>true,'hint'=>'Для видеошаблона: HTTPS-ссылка либо загруженный ниже файл.'],
'video_file'=>['label'=>'Загрузить видео','type'=>'file','accept'=>'.mp4,.webm,video/mp4,video/webm','preview'=>'video','hint'=>'MP4 или WebM, до 100 МБ. Если файл не выбран, сохранится текущее видео.'],
'video_end_seconds'=>['label'=>'Сколько секунд показывать финальный текст','config'=>'video_end_seconds','type'=>'number','min'=>2,'max'=>20,'default'=>6],
