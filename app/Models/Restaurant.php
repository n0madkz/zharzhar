...
{
    protected $fillable = ['name', 'city', 'address', 'phone', 'max_seats', 'default_price_per_guest', 'status', 'partner_user_id'];
    ...
    public function slots(): HasMany { return $this->hasMany(RestaurantSlot::class); }
